...
set:
    ...
    add $a0, $zero, $imm, 2048  ; Address of first  vector @ 2048.
    add $a1, $zero, $imm, 6144  ; Address of second vector @ 6144.
    add $s3, $zero, $imm, 10240 ; Address of result vector @ 10240.
