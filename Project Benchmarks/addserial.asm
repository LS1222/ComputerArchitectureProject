...
set:
    add $a0, $zero, $imm, 0    ; Address of first  vector @ 0.
    add $a1, $zero, $imm, 4096 ; Address of second vector @ 4096.
    add $a0, $zero, $imm, 8192 ; Address of result vector @ 8129.
    add $t0, $zero, $imm, 4096 ; Number of elements to sum.
