...
set:
    ...
    add $a0, $zero, $imm, 3072  ; Address of first  vector @ 3072.
    add $a1, $zero, $imm, 7168  ; Address of second vector @ 7168.
    add $s3, $zero, $imm, 11264 ; Address of result vector @ 11264.
